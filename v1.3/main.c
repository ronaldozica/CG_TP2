...
void inicializaTexturas(){
	...
	idTexturaFundo = carregaTextura("estrellas.png");
...
void DefineIluminacao (void)
{
        ...
        GLfloat posicaoLuz[4]={0.0, 0.0, 3.0, 1.0};
...
void Desenha(void)
{
	...
	glPushMatrix();
		glRasterPos2f(0,-2.8);
		glBindTexture(GL_TEXTURE_2D,text_terra);
		glTranslated(16*-cos(a*0.088),0, 16*-sin(a*0.088));
		glRotated(-20*a, 0, 0, 1);
	...
	glPushMatrix();
		glRasterPos2f(0,-2.8);
		glBindTexture(GL_TEXTURE_2D,text_jupiter);
		glTranslated(26*-cos(a*0.025),0, 26*-sin(a*0.025));
		glRotated(-20*a, 0, 0, 1);
	...
	glPushMatrix();
		glRasterPos2f(0,-2.8);
		glBindTexture(GL_TEXTURE_2D,text_saturno);
		glTranslated(31*-cos(a*0.020),0,31*-sin(a*0.020));
		glRotated(-20*a, 0, 0, 1);
	...
	glPushMatrix();
		glRasterPos2f(0,-2.8);
		glBindTexture(GL_TEXTURE_2D,text_urano);
		glTranslated(36*-cos(a*0.015),0, 36*-sin(a*0.015));
		glRotated(-20*a, 0, 0, 1);
	...
	glPushMatrix();
		glRasterPos2f(0,-2.8);
		glBindTexture(GL_TEXTURE_2D,text_netuno);
		glTranslated(41*-cos(a*0.01),0, 41*-sin(a*0.01));
		glRotated(-20*a, 0, 0, 1);
